...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: "/MoreLessonPlans/:userId",
        name: "morelessonplans",
        component: () => import("pages/MoreLessonPlanPage.vue"),
        props: true
      },
      {
        path: "/user/lessonplanlist/:userId/:lessonplanId",
        name: "lessonplanlist",
        component: () => import("pages/lessonplan/ListPage.vue"),
        props: true
      },
      {
  ...
  },
  {
    path: "/trial",
    name: "trial",
    component: () => import("pages/TrialPage.vue")
  },
  {
    path: "/lessonplan/:lessonplanid/edit",
    beforeEnter: multiguard([auth, isTrial]),
    name: "lessonplanedit",
    component: () => import("pages/lessonplan/EditPage.vue"),
    props: true
  },
  {
    path: "/account/edit",
    name: "accountedit",
    beforeEnter: multiguard([auth, isTrial]),
    component: () => import("pages/account/EditPage.vue")
  },
  {
    path: "/login",
    name: "login",
  ...
  },
  {
    path: "/lessonplan",
    name: "lessonplan",
    component: () => import("pages/LessonPlanPage.vue"),
    props: true
  },
  {
    ...
    beforeEnter: multiguard([auth, isTrial]),
    component: () => import("pages/lessonplan/CommentPage.vue"),
    props: true
  },
  {
    ...
    beforeEnter: multiguard([auth, isTrial]),
    component: () => import("pages/lessonplan/ReviewPage.vue"),
    props: true
  },
  {
    path: "/lessonplan/:lessonplanid/observer",
    beforeEnter: multiguard([auth, isTrial]),
    component: () => import("pages/lessonplan/observer/ListPage.vue"),
    props: true
  },
  {
    path: "/information",
