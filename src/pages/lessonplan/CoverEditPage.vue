...
<div>
    <q-header elevated>
        <q-toolbar class="bg-white">
            <q-btn flat dense icon="arrow_back" class="text-deep-purple" @click="$router.push('/create')" />
            <q-toolbar-title>
                <div class="text-body2 text-deep-purple text-bold">Edit Sampul RPP</div>
            </q-toolbar-title>
            <q-btn flat text-color="deep-purple" @click="saveCover" label="SIMPAN" />
        </q-toolbar>
    </q-header>
    <q-page>
...
export default {
    ...
    methods: {
       saveCover() {
            ...
            this.$store.commit("LessonPlanDraft/setCanvasData", {
                canvas_data: canvas_data,
                image: this.LessonPlanDraft.build.lesson_plan_cover.image
            });
            this.$store.commit("LessonPlanDraft/setCanvasImage", {
